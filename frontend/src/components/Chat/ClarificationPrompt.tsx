      ...
      <div className="flex flex-wrap gap-2 ml-6">
        {question.options.map((option, idx) => (
          <button
            ...
            className="px-3 py-1.5 text-sm bg-white border border-amber-300 text-amber-800 rounded-full hover:bg-amber-100 hover:border-amber-400 transition-colors"
          >
            {option}
          </button>
        ))}
